...
export interface ParticipantRepository {
     ...
     * @param filter
     */
    getAllParticipantPaginatedPerFilter(filter: any): Promise<Paginated<Participant>>

    /**
     *
     * @param participant
     */
    registerParticipant(participant: Participant): Promise<ListResponse<Participant>>
